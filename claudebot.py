"""
╔══════════════════════════════════════════════════════════╗
║         CLAUDEBOT v6 — Polymarket Paper Trader           ║
║                                                          ║
║  Changes from v5:                                        ║
║  • MAX_OPEN_POSITIONS: 5 → 10                            ║
║  • MAX_BET_PCT: 5% → 8%                                  ║
║  • Confidence-tiered Kelly sizing:                       ║
║      ≥90% conf → full Kelly, cap 8%                      ║
║      75-89%    → half Kelly, cap 5%                      ║
║      60-74%    → quarter Kelly, cap 3%                   ║
║  • Opus size_pct override removed — pure Kelly now       ║
║  • Diversification rule: max 2 per category              ║
║  • SCREENER_TOP_N: 6 → 10                                ║
║                                                          ║
...
CONFIDENCE GUIDE — be honest and calibrated:
  90-99%: Near-certain. You have verified, specific evidence (confirmed withdrawal,
          leaked data, real-time stats showing outcome is essentially decided)
...
DIVERSIFICATION RULE — STRICT:
  Max {MAX_PER_CATEGORY} open positions per category (weather/crypto/sports/politics/economics/geopolitics)
  Do NOT recommend a 3rd position in any category already showing {MAX_PER_CATEGORY}
  Spread across categories where possible

NOTE: Do NOT include size_pct in your response — sizing is handled automatically by confidence tier.
...
def print_portfolio(state):
    ...
    print("\n" + "═" * 65)
    print("  CLAUDEBOT v6  ·  Opus 4.6 · Confidence-Tiered Kelly")
    print("═" * 65)
    ...
    print(f"  Max hold       {MAX_HOLD_DAYS}d | Max per category: {MAX_PER_CATEGORY}")
    print("═" * 65)
...
def single_scan():
    print("\n╔══════════════════════════════════════════════════════════╗")
    print("║  CLAUDEBOT v6  ·  Confidence-Tiered Kelly + 10 Slots    ║")
...
def run_loop():
    print("\n╔══════════════════════════════════════════════════════════╗")
    print("║  CLAUDEBOT v6  ·  Continuous Mode                        ║")
    print(f"║  Interval: {SCAN_INTERVAL_MINS}min  |  10 slots  |  Tiered Kelly       ║")
    print("╚══════════════════════════════════════════════════════════╝\n")
